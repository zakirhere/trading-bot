...
TEMPLATE="${PROJECT_ROOT}/deploy/macos/com.tradebot.service.plist.template"
PLIST_DEST="${HOME}/Library/LaunchAgents/com.tradebot.service.plist"
LABEL="com.tradebot.service"
...
echo "Logs: ${HOME}/.tradebot/service-stdout.log and service-stderr.log"
